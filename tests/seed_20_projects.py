...
def survey_body(profile):
    if profile == "strong":
        return {
            ...
            "c1_specialization":"Deep specialist","c2_directness":"Expert authored","c3_judgment_pct":">75% judgment",
            "c6_self_assessment":"Significantly better","c7_analytical_depth":"Exceptional",
            "c8_decision_readiness":"Yes without caveats",
            "d1_proprietary_data":"Yes","d2_knowledge_reuse":"Yes directly reused and extended",
            "d3_moat_test":"No — proprietary inputs decisive",
            "e1_client_decision":"Yes — informed a specific decision",
            "f1_feasibility":"Not feasible","f2_productization":"Yes largely as-is",
            "g1_reuse_intent":"Yes without hesitation",
            "l1_legacy_working_days":30,"l2_legacy_team_size":"4+",
            "l3_legacy_revision_depth":"Major rework","l4_legacy_scope_expansion":"Yes",
            ...
            "l9_legacy_c3_judgment":"25-50%","l10_legacy_d1_proprietary":"No",
            ...
            "l15_legacy_e1_decision":"Too early to tell","l16_legacy_b6_data":"50-75%",
        }
    if profile == "balanced":
        return {
            "b1_starting_point":"Mixed","b2_research_sources":"Multiple sources across domains (5-10)",
            "b3_assembly_ratio":"50-75%","b4_hypothesis_first":"Hybrid","b5_ai_survival":"50-75%",
            "b6_data_analysis_split":"25-50%",
            "c1_specialization":"Deep specialist","c2_directness":"Expert co-authored","c3_judgment_pct":"50-75%",
            "c6_self_assessment":"Somewhat better","c7_analytical_depth":"Strong",
            "c8_decision_readiness":"Yes with minor caveats",
            "d1_proprietary_data":"Yes","d2_knowledge_reuse":"Yes provided useful starting context",
            "d3_moat_test":"Partially — they would miss key insights",
            "e1_client_decision":"Yes — referenced in internal discussions",
            "f1_feasibility":"Feasible but at 2x+ the cost and time","f2_productization":"Yes with moderate customization",
            "g1_reuse_intent":"Yes with reservations",
            "l1_legacy_working_days":20,"l2_legacy_team_size":"3",
            "l3_legacy_revision_depth":"Moderate rework","l4_legacy_scope_expansion":"No",
            "l5_legacy_client_reaction":"Met expectations","l6_legacy_b2_sources":"A few targeted sources (2-4)",
            "l7_legacy_c1_specialization":"Adjacent expertise","l8_legacy_c2_directness":"Expert reviewed only",
            "l9_legacy_c3_judgment":"25-50%","l10_legacy_d1_proprietary":"No",
            "l11_legacy_d2_reuse":"Yes provided useful starting context",
            "l12_legacy_d3_moat":"Yes — all inputs publicly available",
            "l13_legacy_c7_depth":"Adequate","l14_legacy_c8_decision":"Yes with minor caveats",
            "l15_legacy_e1_decision":"Yes — referenced in internal discussions","l16_legacy_b6_data":"50-75%",
        }
    # weak
    return {
        "b1_starting_point":"From blank page","b2_research_sources":"A few targeted sources (2-4)",
        "b3_assembly_ratio":"25-50%","b4_hypothesis_first":"Discovery-first","b5_ai_survival":"25-50%",
        "b6_data_analysis_split":"50-75%",
        "c1_specialization":"Adjacent expertise","c2_directness":"Expert co-authored","c3_judgment_pct":"25-50%",
        "c6_self_assessment":"Comparable","c7_analytical_depth":"Adequate",
        ...
        "f1_feasibility":"Feasible at similar cost","f2_productization":"No fully bespoke",
        "g1_reuse_intent":"Yes with reservations",
        "l1_legacy_working_days":12,"l2_legacy_team_size":"2",
        "l3_legacy_revision_depth":"Cosmetic only","l4_legacy_scope_expansion":"No",
        "l5_legacy_client_reaction":"Exceeded expectations","l6_legacy_b2_sources":"Multiple sources across domains (5-10)",
        "l7_legacy_c1_specialization":"Deep specialist","l8_legacy_c2_directness":"Expert authored",
        "l9_legacy_c3_judgment":"50-75%","l10_legacy_d1_proprietary":"Yes",
        ...
        "l15_legacy_e1_decision":"Yes — informed a specific decision","l16_legacy_b6_data":"25-50%",
    }
